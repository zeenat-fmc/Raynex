...
export default function ProductCard({ product }: ProductCardProps) {
  return (
    <div className="group rx-beam-hover flex flex-col border border-rx-border bg-rx-charcoal transition-colors duration-300 hover:border-rx-blue/60">
      ...
      <div className="flex flex-1 flex-col gap-3 p-6">
        ...
        <h3 className="font-display text-lg font-bold text-rx-white">
          {product.name}
        </h3>

        <p className="flex-1 text-sm leading-relaxed text-rx-muted">
          {product.description}
        </p>
